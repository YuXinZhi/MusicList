...
ListView noshowlist;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		noshowlist.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_expandable_list_item_1,getData()));
		myAnimation =    AnimationUtils.loadAnimation(this,0x7f020001);
        myAnimationbbb = AnimationUtils.loadAnimation(this,0x7f02000a);
