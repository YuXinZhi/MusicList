...
public class appWidgetProvider extends AppWidgetProvider {
	...
	public void onReceive(Context context, Intent intent) {
		...
		PendingIntent startPendingIntent = PendingIntent.getService(context, 0, startIntent,
		...
		PendingIntent frontPendingIntent = PendingIntent.getService(context, 0, frontIntent,
				PendingIntent.FLAG_UPDATE_CURRENT);
		...
		PendingIntent nextPendingIntent = PendingIntent.getService(context, 0, nextIntent,
				PendingIntent.FLAG_UPDATE_CURRENT);
		...
		PendingIntent stopPendingIntent = PendingIntent.getActivity(context, 0, stopIntent,
				PendingIntent.FLAG_UPDATE_CURRENT);
		Intent stopIntent2 = new Intent("ggsdgvrghr");
		PendingIntent stopPendingIntent2 = PendingIntent.getBroadcast(context, 0, stopIntent2,
				PendingIntent.FLAG_UPDATE_CURRENT);

		// 得到RemoteViews对象
		RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.widget_main);
		remoteViews.setOnClickPendingIntent(R.id.widget_frontBtn, frontPendingIntent);
		remoteViews.setOnClickPendingIntent(R.id.widget_startBtn2, startPendingIntent);
		remoteViews.setOnClickPendingIntent(R.id.widget_nextBtn, nextPendingIntent);
		remoteViews.setOnClickPendingIntent(R.id.widget_logo, stopPendingIntent);
		remoteViews.setOnClickPendingIntent(R.id.widget_xiangxi, stopPendingIntent2);
		// 更新widget
