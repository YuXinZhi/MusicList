...
public class PreferenceService {
	...
	public Map<String, String> getPreferences4() {
		...
		SharedPreferences preferences = context.getSharedPreferences("music",
				Context.MODE_PRIVATE);
		params4.put("musicna", preferences.getString("musicna", "江南sytle"));
	...
	public void savelrcurl(String lrcuri) {
		SharedPreferences preferences = context.getSharedPreferences("music",
				Context.MODE_PRIVATE);
		Editor editor = preferences.edit();
		editor.putString("lrcurledit", lrcuri);
		editor.commit();
	}

	public Map<String, String> getPreferenceslrcurl() {
		Map<String, String> paramslrcurl = new HashMap<String, String>();
		SharedPreferences preferences = context.getSharedPreferences("music",
				Context.MODE_PRIVATE);
		paramslrcurl.put("lrcurledit", preferences.getString("lrcurledit", ""));
		return paramslrcurl;
	}

	/*
	 * public void shoucang(String save) { SharedPreferences
	 * preferences=context.getSharedPreferences("music",Context.MODE_PRIVATE);
	 * Editor editor=preferences.edit(); editor.putString("shoucang",save);
	 * editor.commit(); } public Map<String,String>getshoucang(){
	 * Map<String,String>paramsshoucang=new HashMap<String,String>();
	 * SharedPreferences
	 * preferences=context.getSharedPreferences("music",Context.MODE_PRIVATE);
	 * paramsshoucang.put("shoucang", preferences.getString("shoucang",""));
	 * return paramsshoucang; }
	 */
}