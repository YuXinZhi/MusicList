...
public class ListOfArtistsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		musiclist_play.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent intent = new Intent(ListOfArtistsActivity.this,
						MusicActivity.class);
		...
		artistListView.setBackgroundResource(R.drawable.music_land_bg);
		...
		artistListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent intent1 = new Intent(ListOfArtistsActivity.this,
						MusicService.class);
				MusicNum.putplay(8);
