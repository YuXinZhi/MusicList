...
public class Setting extends Activity {
	...
	String KEY[] = { "remember1", "remember2", "remember3", "remember4",
			...
			"remember10", "remember11" };
	private SharedPreferences mSettings = null;
	private SeekBar shuaidong_seekBar;
	SlipButton check[];
	private Close close;
	private LinearLayout shuaige_see, linearsetting11, linearsetting10,
			linearsetting09, linearsetting08, linearsetting07, linearsetting06,
			linearsetting05, linearsetting04, linearsetting03, linearsetting02,
			linearsetting01;
		...
		shuaidong_seekBar
				.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
					...
					public void onProgressChanged(SeekBar seekBar,
						...
						Log.i(mingzi, String.valueOf(progress));
					}
				});
		...
		builder.setSingleChoiceItems(adapter, -1,
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						switch (which) {
						case 0:
							Index.mainindexback.setImageBitmap(null);
							service.background("", 0);
							RemoteViews remoteViesws = new RemoteViews(
									"com.example.musiclist", 0x7f03002c);
							remoteViesws.setImageViewBitmap(0x7f0c00a5, null);
		...
		case activity_result_cropimage_with_data: // 相册
			try {
				if (data!=null && resultCode!=0) {
					...
					Intent intent = new Intent(Setting.this, VolumService.class);
					startService(intent);
				}
			} catch (Exception e) {
				e.printStackTrace();
